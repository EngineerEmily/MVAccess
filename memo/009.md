...
# BACKGROUND  
The U.S. and California Constitutions prohibit governments from taking private property without just compensation.[1](#footnote) Legal challenges to rent control have argued that limits on rent increases take value from a landlord’s property without just compensation; courts have disagreed so long as the rent control ordinance allows a landlord to earn a reasonable or fair return.[2](#footnote) The California Supreme Court has clarified that various formulas and methodologies may be used to reach the desired result (allowing a fair return), and for constitutional purposes, “it is the result reached not the method employed which is controlling.”[3](#footnote)  
